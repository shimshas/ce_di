    ...
    def get_assets(self, record):
        ...
        try:
            ...
            if isinstance(_mfr_raw, list):
                manufacturer = _mfr_raw[0] if _mfr_raw else None
                if isinstance(manufacturer, dict):
                    manufacturer = manufacturer.get("Manufacturer") or manufacturer.get("manufacturer") or str(manufacturer)
            else:
            ...
            # MAC address
            mac_address = None
            _mac_raw = record.get("LocalIpAddresses")
            ...
            # IP address
            ip_address = record.get("PublicIpAddress")
